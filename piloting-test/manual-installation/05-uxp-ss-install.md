...
🔷 Якщо у вас вже є встановлений Graylog:

Використовуйте розділ "Пересилання журналів за допомогою Rsyslog" в [UA-UXP-IG-GRAYLOG].

🔶 Якщо у вас ще немає Graylog, скористайтесь інструкцією:

"Graylog для серверів UXP: Посібник з встановлення та налаштування" [UA-UXP-IG-GRAYLOG].

ℹ️ Підтримується пересилання також до інших систем, але Graylog — рекомендований для повної сумісності.

---

## 🔹 Підключення криптографічного пристрою

1. Підтримувані моделі:
