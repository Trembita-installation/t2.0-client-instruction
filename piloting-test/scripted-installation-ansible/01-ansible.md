...
12. **Встановити компоненти** в наступній послідовності:
  ...
  - **MinIO**
     ...
     ```
**Після встановлення MinIO виконайте пункт за посиланням:** [Перевірка параметра archive-storage-type](../manual-installation/04-minio-install-and-settings.md#перевірка-параметра-archive-storage-type)
