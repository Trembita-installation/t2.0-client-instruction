...
> - [Матеріали для розробників тестових вебсервісів та вебклієнтів (на різних мовах програмування)](Trembita-installation/dev-services-and-clients)
...
Під час проведення пілотування системи Трембіта 2.0 Каталог системи Трембіта не використовується.
...
1. Ідентифікатор ШБО Учасника пілотування:
...
2. Ідентифікатор коду підсистеми:
...
3. Ідентифікатор технологічної підсистеми локального компоненту ПМДПД:
