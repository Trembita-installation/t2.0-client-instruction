...
> ℹ️ **Примітка:** Після досягнення налаштованої квоти MinIO автоматично відхиляти подальші запити PUT до цього bucket.
...
*Статус ```'expiration'``` ініціює для об’єкта операцію ```DELETE```. Наприклад, ви можете створити правило таке життєвого циклу, щоб протермінованими вважались усі об’єкти старші ніж 365 днів.*
...
Перемістіть сертифікат у потрібну директорію:
