...
4. **Встановлено MonHub рішення** згідно з відповідною [інструкцією](../manual-installation/10-mon-hub-install-and-settings.md).

5. **Завантажено проєкт з автоматизованим сценарієм розгортання через Ansible** відповідно до [інструкції](./01-ansible.md).
